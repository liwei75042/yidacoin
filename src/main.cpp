...
int64 nChainStartTime = 1498438762;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Jun 26 , 2017, YiDaCoin Start   .";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0x9303029a9c0412bb6ca485694fbf00f523a942325dda2ba4bd620f597a6942c4"));
